...
import { fetchComments } from "@/features/image/imageThunks";
...
const CommentPanel = ({ showComments, setShowComments,imageId }: CommentPanelProps) => {
...
console.log(comments)
  ...
  const handlePostComment = () => {
    ...
    console.log("Posting comment:", commentText); // Replace with dispatch or API call
    ...
    >
      ...
      <div>
        ...
        <div className="space-y-4 overflow-y-auto max-h-[calc(100vh-200px)]">
          ...
          <p className="text-gray-700">Comment feature coming soon...</p>
        </div>
      </div>
